...
AUTHENTICATION_BACKENDS = ["accounts.backends.MagicLinkBackend"]
...
ROOT_URLCONF = "understory_commons.urls"
...
WSGI_APPLICATION = "understory_commons.wsgi.application"
...
LOGGING = {
    ...
    "loggers": {
        "commons.ai": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}
